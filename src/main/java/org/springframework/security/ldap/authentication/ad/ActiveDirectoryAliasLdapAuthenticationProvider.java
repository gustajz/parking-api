...
public final class ActiveDirectoryAliasLdapAuthenticationProvider extends AbstractLdapAuthenticationProvider {
	 ...
	 */
	public ActiveDirectoryAliasLdapAuthenticationProvider(String domain, String principalDomain, String url, String rootDn) {
		Assert.isTrue(StringUtils.hasText(url), "Url cannot be empty");
		this.domain = StringUtils.hasText(domain) ? domain.toLowerCase() : null;
		this.domainAlias = StringUtils.hasText(principalDomain) ? principalDomain.toLowerCase() : this.domain;
		this.url = url;
	 ...
	 * @param url an LDAP url (or multiple URLs)
	 */
	public ActiveDirectoryAliasLdapAuthenticationProvider(String domain, String principalDomain, String url) {
		Assert.isTrue(StringUtils.hasText(url), "Url cannot be empty");
		this.domain = StringUtils.hasText(domain) ? domain.toLowerCase() : null;
		this.domainAlias = StringUtils.hasText(principalDomain) ? principalDomain.toLowerCase() : this.domain;
		this.url = url;
	...
	String createBindPrincipalDomainAlias(String username) {
		if (domainAlias == null || username.toLowerCase().endsWith(domainAlias)) {
			return username;
		}

		return username + "@" + domainAlias;
	}
